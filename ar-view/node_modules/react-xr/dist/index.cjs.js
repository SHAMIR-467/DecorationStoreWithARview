...
function Hands() {
  ...
  React.useEffect(function () {
    var handFactory = new XRHandModelFactory.XRHandModelFactory().setPath('https://threejs.org/examples/models/fbx/'); // @ts-ignore

    var hand1 = gl.xr.getHand(0);
    scene.add(hand1);
    hand1.add(handFactory.createHandModel(hand1, 'oculus')); // @ts-ignore
